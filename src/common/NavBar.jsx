        ...
        <nav className="navbar">
            <div className="nav-left-group">
                ...
                <div className="controls-group">
                    <button className="control-btn" onClick={handleTheme}>
                        {isDark ? 
                    ...
                    <button className="control-btn lang-toggle" onClick={handleLang}>
            ...
            {/* <div className="nav-logo">
                <img src={whitelogo} alt="Logo" className="logo-img" style={{filter: isDark ? 'none' : 'invert(1)'}} />
            </div> */}
